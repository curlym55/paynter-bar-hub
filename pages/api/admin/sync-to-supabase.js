 ...
 * POST (not GET) so SameSite=Lax cookies aren't carried on a cross-site
 * top-level navigation — a plain <a> link can no longer trigger this.
 */
...
export default async function handler(req, res) {
  // Admin maintenance route: copies Redis keys into Supabase. Management access only.
