...
export function calculateItem(item, settings, targetWeeks = 6) {
  ...
  const minStock    = settings.minStock != null ? Number(settings.minStock) : null
  const targetStock = minStock != null ? Math.max(calculatedTarget, minStock) : calculatedTarget
